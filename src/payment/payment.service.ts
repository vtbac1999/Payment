...
export class PaymentService {
  ...
  async generateDescription() {
    const characters = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'; // Các ký tự có thể dùng
  ...
  validateWebhook(data: Record<string, any>, signature: string): boolean {
